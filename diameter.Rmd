We need to match the data again for the diameter analysis because we only want to consider trees for which the diameter is non-missing. So, we first select the trees for which diameter is non-missing. Then, we match the data (using the same routine as in the `matching.Rmd` file). After matching, we will compare tree diameters. 
